    ...
    public defaultCatch() {
        return catchError((err: any) => {
            if (err) {
                ...
                if (err.status === 401) {
                    summary = this.translate.instant("godev.godev2022desafio.error_unauthorized_title");
                    detail = this.translate.instant("godev.godev2022desafio.error_unauthorized_description");
                }
