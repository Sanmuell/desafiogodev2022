...
export class DoctorListComponent implements OnInit, OnDestroy /*{CA:CLASS_INTERFACES:START}*/ /*{CA:CLASS_INTERFACES:END}*/ {
    public allPermissions: any = {};
    public permissions: any = {};
    public localeConfig: any = {};

    public currentListParams: ListParams = { page: 0, size: 10, sort: [], filterData: {} };
    public gridData: Doctor[];
    public gridColumns: any[];
    public showLoader: boolean;
    public totalRecords: number;
    public selection: Doctor[];
    ...
    @ViewChild("doctorTable", { static: false })
    public table: Table;
    ...
    public ngOnInit() {
        ...
        this.filterFormGroup = this.formBuilder.group({
            ...
            crmNumber: [undefined, Validators.compose([Validators.pattern(/^\-?\d*$/)])],
            crmState: [undefined, Validators.compose([])],
            especiality: [undefined, Validators.compose([])],
        });
    ...
    public onSearch() {
        ...
        if (this.hasEmpty(filterData)) {
            ...
            this.filtersStorageService.storeFilters("DoctorListComponent", filterData);
        }
    ...
    public onClear() {
        ...
        const filterData = this.filterFormGroup.getRawValue();
        this.resetGrid({ filterData });
        this.filtersStorageService.removeFilter("DoctorListComponent");
    ...
    public onRemoveToken(token: IToken) {
        ...
        const filterData = this.filterFormGroup.getRawValue();
        this.resetGrid({ filterData });
        this.filtersStorageService.clearFilterValue("DoctorListComponent", filterData);
    ...
    public onGridChange(event: LazyLoadEvent) {
        ...
        if (size != 10 || page != 0 || sort.length > 0) {
            this.paginatorStorageService.storePaginator("DoctorListComponentPaginator", { page, size, sort });
        }
    ...
    public onDelete() {
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                forkJoin(this.selection.map(doctor => this.doctorService.delete(doctor.id)))
                    .pipe(
    ...
    private getGridColumns() {
        const gridColumns = [
            { field: "id", header: this.translate.instant("godev.godev2022desafio.doctor_id") },
            { field: "name", header: this.translate.instant("godev.godev2022desafio.doctor_name") },
            { field: "cpf", header: this.translate.instant("godev.godev2022desafio.doctor_cpf") },
            { field: "crmNumber", header: this.translate.instant("godev.godev2022desafio.doctor_crm_number") },
            { field: "crmState", header: this.translate.instant("godev.godev2022desafio.doctor_crm_state") },
            { field: "especiality", header: this.translate.instant("godev.godev2022desafio.doctor_especiality") },
        ];
    ...
    private async setStorageFiltersIntoForm(form: FormGroup) {
        ...
        const filters = await this.filtersStorageService.getFilters("DoctorListComponent");
    ...
    private async setStoragePaginator() {
        const paginator = await this.paginatorStorageService.getPaginator("DoctorListComponentPaginator");
