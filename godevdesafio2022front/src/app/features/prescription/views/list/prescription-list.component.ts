...
export class PrescriptionListComponent implements OnInit, OnDestroy /*{CA:CLASS_INTERFACES:START}*/ /*{CA:CLASS_INTERFACES:END}*/ {
    public allPermissions: any = {};
    public permissions: any = {};
    public localeConfig: any = {};

    public currentListParams: ListParams = { page: 0, size: 10, sort: [], filterData: {} };
    public gridData: Prescription[];
    public gridColumns: any[];
    public showLoader: boolean;
    public totalRecords: number;
    public selection: Prescription[];
    ...
    @ViewChild("prescriptionTable", { static: false })
    public table: Table;

    public doctorResponsibleLookupDisplayFields = ["id", "name", "cpf", "crmNumber", "crmState", "especiality"];
    public doctorResponsibleAdvancedDisplayFields = ["id", "name", "cpf", "crmNumber", "crmState", "especiality"];

    public patientLookupDisplayFields = ["id", "name", "cpf", "address", "phone", "isAtivo"];
    public patientAdvancedDisplayFields = ["id", "name", "cpf", "address", "phone", "isAtivo"];
    ...
    public ngOnInit() {
        ...
        this.filterFormGroup = this.formBuilder.group({
            ...
            drug: [undefined, Validators.compose([])],
            description: [undefined, Validators.compose([])],
            data: [undefined, Validators.compose([])],
            type: [undefined, Validators.compose([])],
            statementOfReponsability: [undefined, Validators.compose([])],
        });
    ...
    public onSearch() {
        ...
        if (this.hasEmpty(filterData)) {
            ...
            this.filtersStorageService.storeFilters("PrescriptionListComponent", filterData);
        }
    ...
    public onClear() {
        ...
        const filterData = this.filterFormGroup.getRawValue();
        this.resetGrid({ filterData });
        this.filtersStorageService.removeFilter("PrescriptionListComponent");
    ...
    public onRemoveToken(token: IToken) {
        ...
        const filterData = this.filterFormGroup.getRawValue();
        this.resetGrid({ filterData });
        this.filtersStorageService.clearFilterValue("PrescriptionListComponent", filterData);
    ...
    public onGridChange(event: LazyLoadEvent) {
        ...
        if (size != 10 || page != 0 || sort.length > 0) {
            this.paginatorStorageService.storePaginator("PrescriptionListComponentPaginator", { page, size, sort });
        }
    ...
    public onDelete() {
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                forkJoin(this.selection.map(prescription => this.prescriptionService.delete(prescription.id)))
                    .pipe(
    ...
    private getGridColumns() {
        const gridColumns = [
            { field: "id", header: this.translate.instant("godev.godev2022desafio.prescription_id") },
            { field: "drug", header: this.translate.instant("godev.godev2022desafio.prescription_drug") },
            { field: "description", header: this.translate.instant("godev.godev2022desafio.prescription_description") },
            { field: "data", header: this.translate.instant("godev.godev2022desafio.prescription_data") },
            { field: "type", header: this.translate.instant("godev.godev2022desafio.prescription_type") },
            {
                field: "statementOfReponsability",
                header: this.translate.instant("godev.godev2022desafio.prescription_statement_of_reponsability"),
            },
        ];
    ...
    private async setStorageFiltersIntoForm(form: FormGroup) {
        ...
        const filters = await this.filtersStorageService.getFilters("PrescriptionListComponent");
    ...
    private async setStoragePaginator() {
        const paginator = await this.paginatorStorageService.getPaginator("PrescriptionListComponentPaginator");
