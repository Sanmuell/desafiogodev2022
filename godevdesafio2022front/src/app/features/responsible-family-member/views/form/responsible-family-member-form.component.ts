...
@Component({
    templateUrl: "./responsible-family-member-form.component.html",
    styleUrls: [
...
export class ResponsibleFamilyMemberFormComponent
    ...
    public isNew() {
        return this.routeParams.responsibleFamilyMember == "new";
    }
    ...
    public onRouteDataChange(data: any) {
        ...
        if (data.entity) {
            ...
            const value: any = ResponsibleFamilyMember.fromDto(data.entity);
            this.updateSuggestions(value);
            this.formGroup.patchValue(value);
        } else {
            this.formGroup.patchValue(new ResponsibleFamilyMember());
        }
    ...
    private getFormGroup() {
        const formGroup = this.formBuilder.group({
            ...
            kinship: [{ value: undefined, disabled: false }, Validators.compose([])],
            custom: [],
        });
    ...
    private getSaveObservable() {
        ...
        const responsibleFamilyMemberDto = ResponsibleFamilyMember.toDto(value);

        let observable;

        if (this.isNew()) {
            observable = this.responsibleFamilyMemberService.insert(responsibleFamilyMemberDto);
        } else {
            const id = this.routeParams.responsibleFamilyMember;
            observable = this.responsibleFamilyMemberService.update(id, responsibleFamilyMemberDto);
        }
    ...
    private getDeleteObservable() {
        return this.responsibleFamilyMemberService.delete(this.routeParams.responsibleFamilyMember).pipe(
            tap(() => {
                this.addMessage(
                    "success",
