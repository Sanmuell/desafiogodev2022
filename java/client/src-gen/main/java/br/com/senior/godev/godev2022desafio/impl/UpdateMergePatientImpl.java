 ...
 * 
 */
public class UpdateMergePatientImpl {
	...
	public UpdateMergePatientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Patient input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.UPDATE_MERGE_PATIENT, //
	...
	* The 'updateMerge' request primitive for the Patient entity.
	*/
	public CompletableFuture<Patient> updateMergePatientRequest(Patient input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
