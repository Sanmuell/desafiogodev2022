 ...
 * 
 */
public class RetrieveDoctorImpl {
	...
	public RetrieveDoctorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Doctor.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				Godev2022desafioConstants.DOMAIN, //
				Godev2022desafioConstants.SERVICE, //
				Godev2022desafioConstants.Commands.RETRIEVE_DOCTOR, //
	...
	* The 'retrieve' request primitive for the Doctor entity.
	*/
	public CompletableFuture<Doctor> retrieveDoctorRequest(Doctor.GetRequest input, long timeout, TimeUnit unit) {
