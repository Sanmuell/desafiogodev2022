...
public class ImportDoctorOutput {
    
    @NotNull(message = "importJobId is required")
    public String importJobId;
    
    
    public ImportDoctorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportDoctorOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportDoctorOutput)) {
            return false;
        }
        ImportDoctorOutput other = (ImportDoctorOutput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	ImportDoctorOutputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
