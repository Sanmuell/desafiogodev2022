 ...
 * 
 */
public class UpdatePatientImpl {
	...
	public UpdatePatientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Patient input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.UPDATE_PATIENT, //
	...
	* The 'update' request primitive for the Patient entity.
	*/
	public CompletableFuture<Patient> updatePatientRequest(Patient input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
