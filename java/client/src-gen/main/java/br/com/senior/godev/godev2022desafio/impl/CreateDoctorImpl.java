...
public class CreateDoctorImpl {
	...
	public CreateDoctorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doctor input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.CREATE_DOCTOR, //
	...
	* The 'create' request primitive for the Doctor entity.
	*/
	public CompletableFuture<Doctor> createDoctorRequest(Doctor input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
