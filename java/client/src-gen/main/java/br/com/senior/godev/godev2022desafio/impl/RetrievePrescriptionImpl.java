 ...
 * 
 */
public class RetrievePrescriptionImpl {
	...
	public RetrievePrescriptionImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Prescription.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				Godev2022desafioConstants.DOMAIN, //
				Godev2022desafioConstants.SERVICE, //
				Godev2022desafioConstants.Commands.RETRIEVE_PRESCRIPTION, //
	...
	* The 'retrieve' request primitive for the Prescription entity.
	*/
	public CompletableFuture<Prescription> retrievePrescriptionRequest(Prescription.GetRequest input, long timeout, TimeUnit unit) {
