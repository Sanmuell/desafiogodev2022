 ...
 * 
 */
public class CreateMergePrescriptionImpl {
	...
	public CreateMergePrescriptionImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Prescription input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.CREATE_MERGE_PRESCRIPTION, //
	...
	* The 'createMerge' request primitive for the Prescription entity.
	*/
	public CompletableFuture<Prescription> createMergePrescriptionRequest(Prescription input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
