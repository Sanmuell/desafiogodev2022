...
public class ExportPrescriptionInput {
    ...
    public ExportPrescriptionInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportPrescriptionInput(ExportConfig config) {
        this.config = config;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportPrescriptionInput)) {
            return false;
        }
        ExportPrescriptionInput other = (ExportPrescriptionInput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	ExportPrescriptionInputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
