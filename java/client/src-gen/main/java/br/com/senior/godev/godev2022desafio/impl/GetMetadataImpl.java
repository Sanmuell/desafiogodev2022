...
import br.com.senior.godev.godev2022desafio.GetMetadataInput;
import br.com.senior.godev.godev2022desafio.GetMetadataOutput;
	...
	private Message createMessage(GetMetadataInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.GET_METADATA, //
