 ...
 * 
 */
public class CreateMergeResponsibleFamilyMemberImpl {
	...
	public CreateMergeResponsibleFamilyMemberImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(ResponsibleFamilyMember input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.CREATE_MERGE_RESPONSIBLE_FAMILY_MEMBER, //
	...
	* The 'createMerge' request primitive for the ResponsibleFamilyMember entity.
	*/
	public CompletableFuture<ResponsibleFamilyMember> createMergeResponsibleFamilyMemberRequest(ResponsibleFamilyMember input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
