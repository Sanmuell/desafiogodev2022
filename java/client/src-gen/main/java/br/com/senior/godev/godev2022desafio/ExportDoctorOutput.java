...
public class ExportDoctorOutput {
    
    @NotNull(message = "exportJobId is required")
    public String exportJobId;
    
    
    public ExportDoctorOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportDoctorOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportDoctorOutput)) {
            return false;
        }
        ExportDoctorOutput other = (ExportDoctorOutput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	ExportDoctorOutputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
