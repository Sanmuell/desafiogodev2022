 ...
 * 
 */
public class UpdateMergeDoctorImpl {
	...
	public UpdateMergeDoctorImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doctor input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.UPDATE_MERGE_DOCTOR, //
	...
	* The 'updateMerge' request primitive for the Doctor entity.
	*/
	public CompletableFuture<Doctor> updateMergeDoctorRequest(Doctor input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
