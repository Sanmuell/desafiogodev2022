 ...
 * 
 */
public class CreatePatientImpl {
	...
	public CreatePatientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Patient input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.CREATE_PATIENT, //
	...
	* The 'create' request primitive for the Patient entity.
	*/
	public CompletableFuture<Patient> createPatientRequest(Patient input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
