 ...
 * 
 */
public class UpdateMergePrescriptionImpl {
	...
	public UpdateMergePrescriptionImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Prescription input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				Godev2022desafioConstants.Commands.UPDATE_MERGE_PRESCRIPTION, //
	...
	* The 'updateMerge' request primitive for the Prescription entity.
	*/
	public CompletableFuture<Prescription> updateMergePrescriptionRequest(Prescription input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
