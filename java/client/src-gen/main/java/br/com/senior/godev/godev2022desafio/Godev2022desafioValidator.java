...
/**
 * Validators for payloads accepted/produced by endpoints in godev2022desafio.
 */

@Component("godev.godev2022desafio.godev2022desafioValidator")
public class Godev2022desafioValidator {
	...
	public void setValidatorCheck(ValidatorCheck validatorCheck){
		Godev2022desafioValidator.validatorCheck = validatorCheck;
	}
	
    public static Validator getBeanValidator() {
		if (VALIDATOR == null) {
			synchronized (Godev2022desafioValidator.class) {
