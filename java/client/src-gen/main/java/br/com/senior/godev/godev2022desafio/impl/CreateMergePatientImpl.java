 ...
 * 
 */
public class CreateMergePatientImpl {
	...
	public CreateMergePatientImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Patient input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				Godev2022desafioConstants.DOMAIN, //
				Godev2022desafioConstants.SERVICE, //
				Godev2022desafioConstants.Commands.CREATE_MERGE_PATIENT, //
	...
	* The 'createMerge' request primitive for the Patient entity.
	*/
	public CompletableFuture<Patient> createMergePatientRequest(Patient input, long timeout, TimeUnit unit) {
		Godev2022desafioValidator.validate(input);
