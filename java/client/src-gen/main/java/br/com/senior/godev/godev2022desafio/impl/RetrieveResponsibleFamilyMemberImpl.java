 ...
 * 
 */
public class RetrieveResponsibleFamilyMemberImpl {
	...
	public RetrieveResponsibleFamilyMemberImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ResponsibleFamilyMember.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				Godev2022desafioConstants.DOMAIN, //
				Godev2022desafioConstants.SERVICE, //
				Godev2022desafioConstants.Commands.RETRIEVE_RESPONSIBLE_FAMILY_MEMBER, //
	...
	* The 'retrieve' request primitive for the ResponsibleFamilyMember entity.
	*/
	public CompletableFuture<ResponsibleFamilyMember> retrieveResponsibleFamilyMemberRequest(ResponsibleFamilyMember.GetRequest input, long timeout, TimeUnit unit) {
