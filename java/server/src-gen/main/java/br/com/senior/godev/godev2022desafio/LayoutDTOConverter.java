...
public final class LayoutDTOConverter {
	...
	public static Layoutdto toDto(Layout layout) {
	    ...
	    dto.errorStrategy = br.com.senior.godev.godev2022desafio.ErrorStrategy.valueOf(layout.getErrorStrategy().name());
	    ...
	    for (Field field : layout.getFields()) {
	        ...
	        fdto.fieldType = br.com.senior.godev.godev2022desafio.FieldType.valueOf(field.getFieldType().name());
	        fdto.id = field.getId();
	    ...
	    if (layout.getHooks() != null) {
	        for (Hook hook : layout.getHooks()) {
	            ...
	            hdto.hookFunction = br.com.senior.godev.godev2022desafio.HookFunction.valueOf(hook.getHookFunction().name());
