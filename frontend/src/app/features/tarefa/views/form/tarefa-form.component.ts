...
export class TarefaFormComponent implements OnInit, OnDestroy, AfterViewInit /*{CA:CLASS_INTERFACES:START}*/ /*{CA:CLASS_INTERFACES:END}*/ {
        ...
        this.getSaveObservable()
            ...
            .subscribe(() => {
                ...
                this.onSendFile(filesToDelete, filesToCommit)
                    ...
                    .subscribe(() => {
                        this.addMessage("success", "godev.godev2022.saved_message_title", "godev.godev2022.saved_message_content");
                        this.goBack();
    ...
    private getFormFields() {
        const formField = [
            ...
            new FormField({
                ...
                required: () => false,
                label: this.translate.instant("godev.godev2022.tarefa_participantes"),
                searchTitle: this.translate.instant("godev.godev2022.tarefa_participantes_search_title"),
                searchEmptyTitle: this.translate.instant("godev.godev2022.nothing_found"),
                filterLabel: this.translate.instant("godev.godev2022.filter"),
                filterTitle: this.translate.instant("godev.godev2022.filters"),
                clearLabel: this.translate.instant("godev.godev2022.clear"),
                cancelLabel: this.translate.instant("godev.godev2022.cancel"),
                selectLabel: this.translate.instant("godev.godev2022.select"),
    ...
    private getParticipantesSearchFields() {
        const searchFields = [
            new FormField({
                name: "id",
                label: this.translate.instant("godev.godev2022.participante_id"),
                type: FieldType.String,
            }),
            new FormField({
                name: "nome",
                label: this.translate.instant("godev.godev2022.participante_nome"),
                type: FieldType.String,
            }),
            new FormField({
                name: "idade",
                label: this.translate.instant("godev.godev2022.participante_idade"),
    ...
    private getDeleteObservable() {
        return this.tarefaService.delete(this.routeParams.tarefa).pipe(
            tap(() => {
                this.addMessage("success", "godev.godev2022.deleted_message_title", "godev.godev2022.deleted_message_content");
                this.goBack();
            })
        );
    }
