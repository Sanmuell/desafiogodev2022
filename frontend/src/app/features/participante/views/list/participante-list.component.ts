...
export class ParticipanteListComponent implements OnInit, OnDestroy /*{CA:CLASS_INTERFACES:START}*/ /*{CA:CLASS_INTERFACES:END}*/ {
    ...
    private getGridColumns() {
        const gridColumns = [
            { field: "id", header: this.translate.instant("godev.godev2022.participante_id") },
            { field: "nome", header: this.translate.instant("godev.godev2022.participante_nome") },
            { field: "idade", header: this.translate.instant("godev.godev2022.participante_idade") },
        ];
